...
void printTeamInfo(void){
    ...
    std::cout << "\t [1] Keenan Phillips (s3602528@student.rmit.edu.au)" << std::endl;
    std::cout << "\t [2] Tony Thai (s4002970@student.rmit.edu.au)" << std::endl;
    std::cout << "\t [3] Ravikaran Singh (s3940606@student.rmit.edu.au)" << std::endl;
    //*************
