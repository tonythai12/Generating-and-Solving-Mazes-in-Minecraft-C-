...
public:
    ...
    struct GeneratedBlock {
        GeneratedBlock(mcpp::BlockType originalType, mcpp::Coordinate coordinate) :
            originalType(originalType), coordinate(coordinate) {}
    ...
    void StoreOldBlock(mcpp::MinecraftConnection* mc, const mcpp::Coordinate& coord);
